...
class HolisticLandmarkerHelper(
    ...
    val context: Context,
    val minFaceLandmarksConfidence: Float,
    val minHandLandmarksConfidence: Float,
    val minPoseLandmarksConfidence: Float,
        ...
        try {
            ...
            val optionsBuilder =
                HolisticLandmarker.HolisticLandmarkerOptions.builder()
                    ...
                    .setMinFaceLandmarksConfidence(minFaceLandmarksConfidence)
                    .setMinHandLandmarksConfidence(minHandLandmarksConfidence)
                    .setMinPoseLandmarksConfidence(minPoseLandmarksConfidence)
    ...
    companion object {
        ...
        const val DEFAULT_MIN_FACE_LANDMARKS_CONFIDENCE = 0.5F
        const val DEFAULT_MIN_HAND_LANDMARKS_CONFIDENCE = 0.5F
        const val DEFAULT_MIN_POSE_LANDMARKS_CONFIDENCE = 0.5F

package com.google.mediapipe.examples.imagegeneration.plugins.helper
...
class ImageGenerationHelper(
    ...
    fun initializeFaceImageGenerator(modelPath: String) {
        ...
        val conditionOptions = ConditionOptions.builder().setFaceConditionOptions(faceConditionOptions).build()
